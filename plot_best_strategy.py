...
""" NORMAL CASES """
# Import df_normal create with BuildBestStrategy().normal_cases() (from build_best_strategy.py)
...
""" SPLIT CASES """
# Import df_split create with BuildBestStrategy().split_cases() (from build_best_strategy.py)
